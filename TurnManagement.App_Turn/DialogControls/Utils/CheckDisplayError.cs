...
namespace TurnManagement.App_Turn.DialogControls.Checks
{
    public static class CheckDisplayError
    {
        /// <summary>
        ...
        public static async Task<bool> DisplayErrorMessageBox(string title, string message)
        {
            // Display error
